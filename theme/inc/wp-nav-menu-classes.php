...
class WordPressMenuClasses
{
    ...
    public function __construct()
    {
        ...
        add_filter('walker_nav_menu_start_el', [$this, 'navSubmenuDropdownButton'], 10, 4);
    }
     ...
     *
     * @see https://core.trac.wordpress.org/ticket/33924
     *
     * @param mixed $classes
     */
    ...
    public function navSubmenuDropdownButton($item_output, $item, $depth, $args)
    {
        if (property_exists($args, 'dropdown_button')) {
            if (in_array('menu-item-has-children', $item->classes) || in_array('page_item_has_children', $item->classes)) {
                $item_output = str_replace($args->link_after . '</a>', $args->link_after . '</a>' . $args->dropdown_button, $item_output);
            }
        }
